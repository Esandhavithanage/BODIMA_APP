...
public class Traveller_nav extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_traveller_nav);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.traveller_nav, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_traveller_home) {
        ...
        } else if (id == R.id.nav_traveller_comments) {

            FragmentTransaction tx = getSupportFragmentManager().beginTransaction();
            tx.replace(R.id.trvellermainLayout,new viewComentsTraveler());
            tx.commit();
            ...
            FragmentTransaction tx = getSupportFragmentManager().beginTransaction();
            tx.replace(R.id.trvellermainLayout,new FHistoryTraveler());
            tx.commit();
